...
export default function SocialLinks() {
    ...
    return (
        <div className={s.sLinks}>
            ...
            <Link className={s.sLink} target="_blank" href={'https://github.com/sQuillP'}>
                <FontAwesomeIcon color="var(--text-secondary-2)" icon={faGithub} size="xl"/>
            </Link>
            <Link className={s.sLink} target="_blank" href={'mailto:will.m.pattison@gmail.com?subject=Inquiry'}>
